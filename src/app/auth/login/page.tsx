      ...
      <div className="flex-1 flex flex-col justify-center p-8 md:p-20 relative">
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="mt-12">
            ...
            <button className="w-full py-4 border border-[var(--border-subtle)] flex items-center justify-center gap-3 text-sm font-medium hover:bg-gray-50 transition-colors rounded-xl">
