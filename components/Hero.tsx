  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center -translate-y-6">
        ...
        {/* Heading */}
        <h1 className="text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl font-black text-white leading-[0.85] mb-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          LET US HELP YOU<br />
