...
erDiagram
  ...
  RateItem ||--o{ RateItemStatusHistory : "history"
  ...
  StudentEnrolmentItem ||--o{ StudentEnrolmentItemStatusHistory : "history"
  ...
  TeacherEnrolmentItem ||--o{ TeacherEnrolmentItemStatusHistory : "history"
  ...
  StaffEnrolmentItem ||--o{ StaffEnrolmentItemStatusHistory : "history"
  ...
  AmbassadorEnrolmentItem ||--o{ AmbassadorEnrolmentItemStatusHistory : "history"
  ...
  AmbassadorCommissionItem ||--o{ AmbassadorCommissionItemStatusHistory : "history"
  ...
  ScheduleOccurrence ||--o{ ScheduleOccurrenceStatusHistory : "history"
  ...
  StaffScheduleOccurrence ||--o{ StaffScheduleOccurrenceStatusHistory : "history"
  ...
  StaffScheduleOccurrenceStatusHistory {
    cuid id PK
    cuid occurrenceId FK
    string fromStatus
    string toStatus
  ...
  AmbassadorScheduleOccurrence ||--o{ AmbassadorScheduleOccurrenceStatusHistory : "history"
  ...
  AmbassadorScheduleOccurrenceStatusHistory {
    cuid id PK
    cuid occurrenceId FK
    string fromStatus
    string toStatus
  ...
  CurriculumList ||--|| SyllabusList : "has"
  ...
  Referral ||--o{ AmbassadorCommissionItem : "generates"
  ...
  InvoiceMonth ||--o{ Paycheck : "period"
  InvoiceMonth ||--o{ AmbassadorPaycheck : "period"
  ...
  AmbassadorClaim ||--|| AmbassadorPaycheck : "triggers"
